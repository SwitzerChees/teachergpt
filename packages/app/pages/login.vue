<template>
  <div class="bg-slate-800 rounded p-4 flex flex-col py-12 gap-4 border-2 border-slate-700">
    <h1 class="self-center">Einloggen</h1>
    <span class="text-blue-200">Logge dich mit deinem Microsoft Konto ein.</span>
